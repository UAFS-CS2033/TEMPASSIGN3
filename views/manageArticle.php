...
<div class="container">
        <div class="col">
            ...
            <button class="btn btn-primary" type="submit" name="page" value="adminEditArticle">Edit Article</button>
            <table class="table table-bordered table-striped">
                <thead><tr><th>Article ID</th><th>Title</th><th></th></tr></thead>
                <tbody>
                    <?php
                        for($index=0;$index<count($authorArticles);$index++){
                            echo "<tr><td><input type=\"radio\" name=\"id\" value=\"".$authorArticles[$index]->getArtId()."\"></td>";
